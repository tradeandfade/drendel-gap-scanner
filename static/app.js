  ...
  try{
    ...
    if(d.zones&&d.zones.length>0&&bars.length>0){
      for(var zi=0;zi<d.zones.length;zi++){
        var z=d.zones[zi];
        var lineClr,fillClr;
        if(z.is_untested){lineClr='rgba(176,160,64,0.4)';fillClr='rgba(176,160,64,0.05)'}
        else if(z.base_type==='support'){lineClr='rgba(90,154,76,0.4)';fillClr='rgba(90,154,76,0.05)'}
        else{lineClr='rgba(180,80,64,0.4)';fillClr='rgba(180,80,64,0.05)'}
